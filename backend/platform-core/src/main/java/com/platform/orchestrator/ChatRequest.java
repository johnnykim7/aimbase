 ...
 *                       type="json_schema" 시 schema 필드에 인라인 JSON Schema 또는 schema_ref에 스키마 ID 지정.
 */
public record ChatRequest(
    ...
    public ChatRequest(String model, List<UnifiedMessage> messages) {
        this(model, null, messages, false, false, null, null, null, null, null, null);
    }

    /** 기존 호환용 생성자 (toolFilter/toolChoice/responseFormat 없음) */
    public ChatRequest(String model, String sessionId, List<UnifiedMessage> messages,
        ...
        this(model, sessionId, messages, stream, actionsEnabled, userId, ragSourceId, connectionId, null, null, null);
    }

    /** 기존 호환용 생성자 (responseFormat 없음) */
    public ChatRequest(String model, String sessionId, List<UnifiedMessage> messages,
                       boolean stream, boolean actionsEnabled, String userId,
                       String ragSourceId, String connectionId,
