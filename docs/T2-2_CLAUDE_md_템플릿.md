...
아래는 프로젝트 루트에 배치할 `CLAUDE.md` 내용입니다.
...
## 현재 진행 상태
- [x] Sprint 0: 인프라 세팅
- [x] Sprint 1-10: BE 전체 구현
- [x] Sprint 11-14: FE 전체 구현

## 참조 문서
- `docs/T1-requirements/` — 요구사항 명세
- `docs/T2-architecture/` — 아키텍처 설계
- `docs/T3-detail-design/` — 상세 설계
- `docs/T4-post-impl/` — 구현 이후 산출물
