...
> 설계 버전: 2.6 | 최종 수정: 2026-03-31 | 관련 CR: CR-007, CR-011, CR-012, CR-016
...
| 빌트인 도구 (BuiltIn) | 4 | 4 | 0 | ZipExtractTool(ZIP 압축 해제), TempCleanupTool(임시 폴더 정리), GetCurrentTimeTool, CalculatorTool | CR-016 (zip/cleanup) |
| 공용 워크플로우 (Platform) | 4 | 3 | 1 | Master DB 공용 워크플로우 CRUD+실행, SUB_WORKFLOW StepType, 시드 6개 | CR-016, SUPER_ADMIN |
| **Spring 소계** | **116** | **80** | **36** | | |
