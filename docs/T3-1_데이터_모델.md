...
> 설계 버전: 4.0 | 최종 수정: 2026-04-07 | 관련 CR: CR-002, CR-010, CR-011, CR-012, CR-013, CR-014, CR-015, CR-016, CR-018, CR-019, CR-021, CR-025, CR-029, CR-031, CR-032
...
### subagent_runs (서브에이전트 실행) [v4.0, CR-030/CR-031]
...
| agent_type | VARCHAR(50) | ❌ | 'general-purpose' | 에이전트 유형 |
...
- 인덱스: `idx_subagent_runs_parent` (parent_session_id), `idx_subagent_runs_status` (status)
